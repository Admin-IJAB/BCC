...
(function () {
    ...
    const clearPlayer = () => {
        ...
        audioPlayer.src = "https://Admin-IJAB.github.io/BCC/assets/music/mario3.mp3"; // neu
    ...
    const filterPlayer = () => {
        ...
        const songHome = `https://Admin-IJAB.github.io/BCC/assets/music/${wiper.url}.mp3`; // neu
        const albumHome = `https://Admin-IJAB.github.io/BCC/assets/images/${wiper.art}`; // neu
